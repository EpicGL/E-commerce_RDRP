                ...
                <Col sm={12} lg={2} className='d-flex flex-column top-0 ps-5 pe-5 ps-lg-0 pe-lg-0'>
                    ...
                    <div className='d-flex justify-content-between mt-3'>
                        <input onChange={(e) => setFilter({
                            ...filter, 'startingprice': e.target.value.toString().replace(/[^0-9]/g, '')
                        })} className='form-control me-1' value={filter.startingprice} type="text" />
                        <input onChange={(e)=> setFilter({...filter, 'endprice':e.target.value.toString().replace(/[^0-9]/g, '') })} className='form-control' value={filter.endprice} type="text" />
                    </div>
